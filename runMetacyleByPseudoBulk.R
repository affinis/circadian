...
setwd("/lustre/home/acct-medll/medll/data/analysis/OSgenePredict_PseudoBulk_20k_all_genes_level1.5_unspliced/")
command_exe<-paste0("mkdir block",gene_block_index)
system(command_exe)
outdir<-paste0("/lustre/home/acct-medll/medll/data/analysis/OSgenePredict_PseudoBulk_20k_all_genes_level1.5_unspliced/block",gene_block_index,"/")
