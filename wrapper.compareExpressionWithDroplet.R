...
metacells<-readRDS('/tmpdata/LyuLin/analysis/circadian/R/seacell.0.08.rds')

AllJTKresult<-readJTKFromMetaCells('/tmpdata/LyuLin/analysis/circadian/R/seacell.meta2d.0.08.normalizedbyMetacellSize/')
...
droplet.mat<-LayerData(droplets,layer="data")
...
saveRDS(AllJTKresult.filtered,"/tmpdata/LyuLin/analysis/circadian/R/JTK.result.filtered.addp2bkg.rds")
